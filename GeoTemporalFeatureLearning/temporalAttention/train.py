...
from trainer import GTFL_Trainer
...
def run_trainer(config):
	...
	train_num_frames=8
	train_dataset = BDD_GSV_EncoderFeats_Dataset(feats_dir, phase='train', clip_len=num_frames, num_frames=train_num_frames, feat_files=list0, city_name='sf_train')
	...
	val_dataset1 = BDD_GSV_EncoderFeats_Dataset(feats_dir, phase='val', clip_len=num_frames, num_frames=num_frames, feat_files=list1, city_name='sf' )
	...
	val_dataset2 = BDD_GSV_EncoderFeats_Dataset(feats_dir, phase='val', clip_len=num_frames, num_frames=num_frames, feat_files=list2, city_name='berkeley')
	...
	val_dataset3 = BDD_GSV_EncoderFeats_Dataset(feats_dir, phase='val', clip_len=num_frames, num_frames=num_frames, feat_files=list3, city_name='ny')
	...
	val_dataset4 = BDD_GSV_EncoderFeats_Dataset(feats_dir, phase='val', clip_len=num_frames, num_frames=num_frames, feat_files=list4, city_name='bayarea')
